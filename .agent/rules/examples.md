...
1. SAM3 源码: 使用ultralytics的SAM3模型。权重文件由用户自行准备。
2. 在别的项目中实现了相关的功能，位于.agent/references/文件夹下
...
3. PySide6-Fluent-Widgets的官方案例，位于.agent/references/fluentwidget_example中，特别的，gallery/app/view中，有大量demo的示例